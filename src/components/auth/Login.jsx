...
const Login = () => {
  ...
  const demoLogin = async () => {
    setEmail('demo@devdarshan.com');
    setPassword('demo123');
    setLoading(true);
    try {
      await signIn('demo@devdarshan.com', 'demo123');
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in to book your divine darshan
          </p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex justify-center items-center gap-3 py-2.5 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 transition-all"
        >
        ...
        <button
          onClick={demoLogin}
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-gray-50 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-all"
        >
          Try Demo Account
        </button>
